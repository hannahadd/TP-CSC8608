...
# ─────────────────────────────────────────────
#  Regex PII (version améliorée post-traitement)
# ─────────────────────────────────────────────
...
# ─────────────────────────────────────────────
#  Post-traitement : normalisation du transcript
# ─────────────────────────────────────────────
...
def preclean(text: str) -> str:
    ...
    # Ajouter un espace après ponctuation collée
...
def redact_spoken_email(text: str) -> Tuple[str, int]:
    ...
    2) sinon masque par contexte : 'reach me ...' jusqu'à un marqueur ou fin
    """
    count = 0
